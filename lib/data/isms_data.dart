...
const List<IsmMeta> kIsms = [
  ...
  IsmMeta(
    ...
    notableFigures: [
      ...
      NotableFigure(name: 'Simone de Beauvoir', contribution: 'Existentialist philosopher; The Second Sex.'),
  ...
  IsmMeta(
    ...
    weeklyChallenge: 'Pick a societal rule you follow blindly. Examine why — and whether it still makes sense.',
    category: 'meaning_existence', visualStyle: ArtStyle.existential,
  ...
  IsmMeta(
    ...
    modernApplication: 'Absurdism helps people accept uncertainty and find lightness in dark times. It\'s an antidote to perfectionism and existential dread.',
    quotes: [
      '"One must imagine Sisyphus happy." – Camus',
  ...
  IsmMeta(
    ...
    description: 'A worldview centred on human values and agency. It emphasises ethics, science, and the inherent worth of every person.',
    ...
    overview: 'Humanism has roots in Renaissance thinkers like Petrarch and Erasmus, but modern secular humanism arose in the 19th-20th centuries. It asserts that humans can live ethical, fulfilling lives based on reason and empathy. It champions human rights, democracy, and education.',
    ...
    keyWorks: ['The Demon-Haunted World (Sagan)', 'Frontiers of Justice (Nussbaum)'],
  ...
  IsmMeta(
    ...
    overview: 'Individualism champions the moral worth of the individual. It emerged strongly during the Enlightenment and was central to liberal democracy. Thinkers like John Locke argued that individuals have inalienable rights and that society should serve the individual, not the other way around.',
    historicalContext: 'The Renaissance celebrated individual genius; the Enlightenment proclaimed natural rights; the American Revolution was built on individual liberty.',
    coreTenets: ['Personal autonomy', 'Self-reliance', 'Freedom of thought', 'Individual rights', 'Non-conformity'],
    notableFigures: [
      ...
      NotableFigure(name: 'John Stuart Mill', contribution: 'On Liberty; the harm principle.'),
    ],
    modernApplication: 'Individualism supports entrepreneurship, creative expression, and personal growth. It warns against groupthink and conformity.',
    quotes: [
  ...
  IsmMeta(
    ...
    overview: 'Collectivism emphasises social harmony, cooperation, and shared responsibility. It is foundational to many indigenous cultures and Eastern philosophies. It ranges from democratic community organising to traditional familial duty.',
    historicalContext: 'Tribal societies operated collectively for survival. Confucianism stressed familial and social duties. Modern welfare states blend individual rights with collective responsibility.',
    coreTenets: ['Common good', 'Social solidarity', 'Cooperation', 'Shared responsibility', 'Duty to the community'],
    notableFigures: [
      NotableFigure(name: 'Confucius', contribution: 'Chinese sage; emphasised filial piety and social harmony.'),
      NotableFigure(name: 'Martin Luther King Jr.', contribution: 'Civil rights leader; beloved community.'),
    ],
    modernApplication: 'Collectivist values drive public healthcare, community organising, and mutual aid. They remind us that no one thrives alone.',
    quotes: [
  ...
  IsmMeta(
    ...
    notableFigures: [
      NotableFigure(name: 'Diogenes', contribution: 'Greek Cynic who lived with nothing and questioned everything.'),
  ...
  IsmMeta(
    ...
    category: 'self_society', visualStyle: ArtStyle.creativity,
    overview: 'Hedonism originates with the ancient Greek Cyrenaics, who advocated immediate physical pleasure. Epicurus later refined it to mean the absence of pain (ataraxia) and simple pleasures. Positive psychology now studies happiness and well-being scientifically.',
    ...
    coreTenets: ['Pleasure as intrinsic good', 'Avoid pain', 'Pursue happiness', 'Moderation (Epicureanism)', 'Joy is legitimate'],
    notableFigures: [
      NotableFigure(name: 'Epicurus', contribution: 'Greek philosopher of simple pleasures and friendship.'),
      NotableFigure(name: 'John Stuart Mill', contribution: 'Refined the calculus, distinguishing higher and lower pleasures.'),
      NotableFigure(name: 'Martin Seligman', contribution: 'Positive psychology; the science of flourishing.'),
    ],
    ...
    keyWorks: ['Principia Ethica', 'Utilitarianism', 'Authentic Happiness (Seligman)'],
  ...
  IsmMeta(
    ...
    challenge: 'Skip one comfort today (your favourite snack, warm shower) and observe your mind\'s reaction.',
    ...
    overview: 'Ascetic practices are found in almost every tradition: Christian monasticism, Buddhist monkhood, Hindu sadhus, and Stoic self-denial. The aim is to transcend bodily desires and achieve a higher state of consciousness or moral purity. It\'s also used in modern physical training to forge mental toughness.',
    ...
    notableFigures: [
      ...
      NotableFigure(name: 'Mahatma Gandhi', contribution: 'Used fasting and simplicity as political and spiritual tools.'),
    ],
    modernApplication: 'Intermittent fasting, digital detoxes, and cold showers are secular forms of asceticism. They build willpower and clarity.',
    quotes: [
  ...
  IsmMeta(
    ...
    overview: 'Pragmatism emerged in the late 19th-century United States with Charles Sanders Peirce, William James, and John Dewey. They rejected abstract metaphysical debates and focused on the practical effects of ideas. A belief is true if it works, if it helps us navigate the world effectively.',
  ...
  IsmMeta(
    ...
    overview: 'Optimism is both a psychological trait and a philosophical stance. Positive psychology (Martin Seligman) studies learned optimism, showing it improves health and resilience. However, unchecked optimism can become denial — the goal is realistic, grounded hope.',
    ...
    notableFigures: [
      ...
      NotableFigure(name: 'Viktor Frankl', contribution: 'Found hope even in the worst conditions.'),
  ...
  IsmMeta(
    ...
    weeklyChallenge: 'Practise "defensive pessimism": mentally rehearse worst-case scenarios, then plan how to handle them.',
    category: 'mental_emotional', visualStyle: ArtStyle.existential,
    overview: 'Philosophical pessimism is articulated by Schopenhauer, who saw life as endless striving and suffering. However, pessimism can serve as a coping mechanism — by expecting the worst, you are rarely surprised and can prepare more effectively. Defensive pessimism is a legitimate psychological strategy.',
  ...
  IsmMeta(
    ...
    description: 'A school of thought that rejects social conventions and materialism, advocating a simple, virtuous life in accordance with nature.',
    ...
    historicalContext: 'Diogenes the Cynic (4th century BCE) famously told Alexander the Great to step out of his light. The movement influenced Stoicism and later satirists.',
    coreTenets: ['Reject social conventions', 'Live simply', 'Shameless honesty', 'Critique of power', 'Self-sufficiency'],
    notableFigures: [
      NotableFigure(name: 'Diogenes of Sinope', contribution: 'Founder of Cynicism; lived radically simply.'),
  ...
  IsmMeta(
    ...
    category: 'mental_emotional', visualStyle: ArtStyle.creativity,
    overview: 'Romanticism began in the late 18th century as a reaction against the Industrial Revolution and Enlightenment rationalism. Poets like Wordsworth, Keats, and Goethe celebrated nature, passion, and the sublime. It influenced the Gothic novel and a deep reverence for inner life.',
    historicalContext: 'Originating in Germany (Sturm und Drang) and Britain, Romanticism spread across Europe. Figures like Beethoven and Delacroix embodied its spirit in music and painting.',
    ...
    modernApplication: 'Romantic ideals fuel self-expression, authenticity, and the appreciation of beauty. They remind us that not everything valuable can be measured.',
    quotes: [
  ...
  IsmMeta(
    ...
    overview: 'Philosophical realism asserts that objects exist mind-independently. In art and literature, realism (Flaubert, Ibsen) depicted everyday life without romantic gloss. In politics, realism focuses on power and human nature as it is, not as it should be.',
    ...
    coreTenets: ['Objective reality exists', 'Honest observation', 'Reject idealisation', 'Focus on evidence', 'Truth before comfort'],
    notableFigures: [
  ...
  IsmMeta(
    ...
    challenge: 'Practise mindfulness for five minutes: simply observe your breath without trying to change it.',
    ...
    overview: 'Buddhism\'s core insight is the Four Noble Truths: life involves suffering (dukkha); suffering comes from craving; suffering can end (nirvana); the Eightfold Path leads to liberation. It emphasises meditation, ethical conduct, and wisdom. It\'s less a religion of worship and more a practical psychology.',
  ...
  IsmMeta(
    ...
    description: 'An ancient Chinese philosophy teaching harmony with the Tao (the Way), simplicity, and effortless action (wu wei).',
    ...
    category: 'spiritual_eastern', visualStyle: ArtStyle.mindfulness,
    overview: 'Taoism originates with Laozi and Zhuangzi. The Tao Te Ching emphasises humility, flexibility, and the power of softness. Wu wei (non-action) means acting in alignment with the natural order, not straining against it.',
    ...
    modernApplication: 'Taoist principles are used in stress reduction and leadership. It encourages going with the flow.',
    quotes: [
  ...
  IsmMeta(
    ...
    weeklyChallenge: 'Practise one of the "Five Constants" each day: benevolence, righteousness, propriety, wisdom, faithfulness.',
    ...
    historicalContext: 'Confucius lived during the chaotic Spring and Autumn period (6th-5th century BCE). His ideas were compiled in the Analects. Later, Mencius and Xunzi expanded the philosophy.',
    ...
    notableFigures: [
      ...
      NotableFigure(name: 'Xunzi', contribution: 'Argued human nature must be shaped; education is crucial.'),
    ],
    modernApplication: 'Confucian values offer a model of ethical leadership based on virtue, not fear. They underpin a deep respect for learning and character development.',
    quotes: [
      '"Do not do to others what you do not want done to yourself." – Confucius',
  ...
  IsmMeta(
    id: 'virtue_ethics', name: 'Virtue Ethics', icon: '⚡',
    tagline: 'You are not what you feel — you are what you repeatedly do.',
    description: 'An ancient Greek approach to living well: develop strong character, and the good life follows.',
    challenge: 'Identify one virtue you want to strengthen today — courage, patience, honesty. Act on it once, intentionally.',
    weeklyChallenge: 'Choose one virtue to practise deliberately every day this week. At the end, journal what shifted.',
    category: 'ethics_morality', visualStyle: ArtStyle.discipline,
    overview: 'Aristotle argued that happiness (eudaimonia) isn\'t a feeling — it\'s a way of living. Virtues like courage, honesty, and compassion are habits built through repetition. You aren\'t born brave; you become brave by doing brave things. Virtue Ethics asks not "what should I do?" but "what kind of person should I become?"',
    historicalContext: 'Rooted in Aristotle\'s Nicomachean Ethics (350 BCE). Revived in the 20th century by Alasdair MacIntyre and Philippa Foot as an alternative to rule-based ethics.',
    coreTenets: ['Character over rules', 'Eudaimonia (flourishing)', 'Virtue is a habit', 'The golden mean', 'Community shapes character'],
    notableFigures: [
      NotableFigure(name: 'Aristotle', contribution: 'Nicomachean Ethics; the virtuous life as human flourishing.'),
      NotableFigure(name: 'Thomas Aquinas', contribution: 'Integrated Aristotelian virtue into Christian ethics.'),
      NotableFigure(name: 'Alasdair MacIntyre', contribution: 'After Virtue; revived the tradition for modern ethics.'),
    ],
    modernApplication: 'When you are struggling, Virtue Ethics shifts the question from "why is this happening to me?" to "who do I want to be through this?"',
    quotes: [
  ...
  IsmMeta(
    id: 'logotherapy', name: 'Logotherapy', icon: '🕯️',
    tagline: 'He who has a why can bear almost any how.',
    description: 'A meaning-centred psychology developed by Viktor Frankl in the Nazi death camps. If you can find meaning, you can survive anything.',
    challenge: 'Write one sentence answering: "What is the specific meaning that only I can give to this moment?"',
    weeklyChallenge: 'Each morning this week, write one reason why today matters — not in general, but for you, specifically.',
    category: 'mental_emotional', visualStyle: ArtStyle.existential,
    overview: 'Viktor Frankl survived Auschwitz by observing that prisoners who held onto meaning lived longer than those who gave up. He built Logotherapy on this: the primary human drive is not pleasure (Freud) or power (Adler) — it is meaning. Even in the worst circumstances, you can choose your attitude. The last human freedom is the freedom of response.',
    historicalContext: 'Developed through Frankl\'s experience in concentration camps, 1941-1945. Frankl wrote Man\'s Search for Meaning from memory after liberation. It has sold over 16 million copies.',
    coreTenets: ['Will to meaning', 'Freedom of response', 'Meaning in suffering', 'Responsibility', 'Transcendence'],
    notableFigures: [
      NotableFigure(name: 'Viktor Frankl', contribution: 'Holocaust survivor; founded Logotherapy; Man\'s Search for Meaning.'),
      NotableFigure(name: 'Irvin Yalom', contribution: 'Existential psychotherapist; extended Frankl\'s work.'),
    ],
    modernApplication: 'When life feels pointless or crushing, Logotherapy doesn\'t tell you to feel better — it asks you to find a reason. That reason becomes the anchor everything else holds onto.',
    quotes: [
  ...
  IsmMeta(
    id: 'epicureanism', name: 'Epicureanism', icon: '🍃',
    tagline: 'Simple pleasures. Deep friendship. Quiet contentment.',
    description: 'An ancient Greek philosophy teaching that true happiness comes from friendship, tranquillity, and freedom from fear — not luxury or status.',
    challenge: 'Identify one simple pleasure you\'ve been ignoring. Savour it fully today.',
    weeklyChallenge: 'Have one slow, undistracted meal with someone you care about. No phones. Just conversation.',
    category: 'mental_emotional', visualStyle: ArtStyle.mindfulness,
    overview: 'Often misread as pure hedonism, Epicurus actually taught ataraxia (tranquillity) and aponia (absence of pain) as the highest goods. He believed that the more you chase luxury and status, the more anxious you become. True pleasure is simple: good food, close friends, and a mind free from dread.',
    historicalContext: 'Founded in Athens around 307 BCE. Epicurus and friends lived communally in "The Garden." Lucretius later spread Epicurean ideas through Rome in De Rerum Natura.',
    coreTenets: ['Ataraxia (tranquillity)', 'Aponia (absence of pain)', 'Friendship above all', 'Freedom from fear', 'Simple pleasures'],
    notableFigures: [
      NotableFigure(name: 'Epicurus', contribution: 'Founder; taught happiness through simple living and close friendship.'),
      NotableFigure(name: 'Lucretius', contribution: 'Roman poet; De Rerum Natura spread Epicurean ideas.'),
      NotableFigure(name: 'Thomas Jefferson', contribution: 'Called himself an Epicurean; valued its practical ethics.'),
    ],
    modernApplication: 'Epicureanism is a direct corrective to modern anxiety. When everything feels overwhelming, it asks: what do you actually need to feel okay? Usually less than you think.',
    quotes: [
  ...
  IsmMeta(
    id: 'wabi_sabi', name: 'Wabi-sabi', icon: '🪨',
    tagline: 'Beauty lives in the broken, the worn, and the impermanent.',
    description: 'A Japanese aesthetic philosophy that finds beauty in imperfection, impermanence, and incompleteness — the very things we usually want to fix or hide.',
    challenge: 'Find one "flaw" in yourself or your surroundings today. Look at it without judgment. Just notice it.',
    weeklyChallenge: 'Each day this week, find beauty in something imperfect — a cracked mug, an unfinished thought, a moment that didn\'t go to plan.',
    category: 'mental_emotional', visualStyle: ArtStyle.mindfulness,
    overview: 'Wabi-sabi is the Japanese art of finding beauty in the incomplete and impermanent. Wabi means "rustic simplicity." Sabi means "the beauty of age and wear." Together they describe an acceptance of the natural cycle: things are born, age, break, and return to nothing. Rather than something to resist, this is the texture of a real, lived life.',
    historicalContext: 'Rooted in Japanese Zen Buddhism and tea ceremony culture, developed from the 15th century onwards. The tea master Sen no Rikyū made wabi-sabi central to the Japanese tea ceremony — imperfect, hand-made bowls were prized over perfect ones.',
    coreTenets: ['Impermanence', 'Incompleteness', 'Imperfection', 'Simplicity', 'Acceptance of transience'],
    notableFigures: [
      NotableFigure(name: 'Sen no Rikyū', contribution: 'Tea master who made wabi-sabi the heart of Japanese aesthetics.'),
      NotableFigure(name: 'Leonard Koren', contribution: 'Wrote Wabi-Sabi for Artists, Designers, Poets & Philosophers.'),
    ],
    modernApplication: 'Wabi-sabi is an antidote to perfectionism and social media pressure. You don\'t need to be healed, finished, or perfect. You just need to be real.',
    quotes: [
  ...
  IsmMeta(
    id: 'ikigai', name: 'Ikigai', icon: '🌸',
    tagline: 'Your reason for getting up in the morning.',
    description: 'A Japanese concept meaning "reason for being" — found at the intersection of what you love, what you\'re good at, what the world needs, and what sustains you.',
    challenge: 'Write down one thing you did this week that gave you genuine energy. That\'s a thread toward your ikigai.',
    weeklyChallenge: 'Complete the ikigai map: list what you love, what you\'re good at, what the world needs, and what you could earn from. Where do they overlap?',
    category: 'personal_growth', visualStyle: ArtStyle.mindfulness,
    overview: 'Ikigai literally means "that which makes life worth living." Okinawa, Japan — home to more centenarians per capita than anywhere on Earth — has no word for retirement. People keep living with purpose. Research shows that having an ikigai is strongly correlated with longevity, mental health, and resilience.',
    historicalContext: 'Okinawan cultural concept studied by Japanese geriatric psychiatrist Michiko Kamiya in the 1960s. Gained global attention through Héctor García and Francesc Miralles\'s 2016 book.',
    coreTenets: ['Purpose over happiness', 'Small joys accumulate', 'Flow states matter', 'Long-term orientation', 'Contribution to others'],
    notableFigures: [
      NotableFigure(name: 'Michiko Kamiya', contribution: 'First to study ikigai as a medical-psychological concept.'),
      NotableFigure(name: 'Héctor García', contribution: 'Popularised ikigai globally through Ikigai: The Japanese Secret.'),
    ],
    modernApplication: 'When you\'ve lost direction, ikigai offers a map. You don\'t need to find it all at once — just follow what energises you until the circles start to overlap.',
    quotes: [
  ...
  IsmMeta(
    id: 'rationalism', name: 'Rationalism', icon: '🧩',
    tagline: 'Your most powerful tool is already between your ears.',
    description: 'A philosophical approach holding that reason and logical analysis are the path to truth — and to overcoming distorted thinking that holds us back.',
    challenge: 'Take one fear making you anxious right now. Write it out. Test it: is this logical? What\'s the actual evidence?',
    weeklyChallenge: 'Each morning, identify one assumption you\'re carrying. Ask: did I choose this belief, or did it just happen to me?',
    category: 'mental_emotional', visualStyle: ArtStyle.reason,
    overview: 'Rationalism begins with Descartes\' realisation: the only thing you can\'t doubt is that you\'re thinking. From this single certainty, you can rebuild a more reliable worldview. In practice, it trains you to separate emotion from analysis — not to suppress feelings, but to stop letting distorted thinking run unchecked. This is the foundation of cognitive behavioural therapy.',
    historicalContext: 'René Descartes launched the rationalist tradition with Meditations on First Philosophy (1641). Spinoza and Leibniz developed it further. The scientific method is its greatest practical legacy.',
    coreTenets: ['Reason over distortion', 'Deductive reasoning', 'Questioning assumptions', 'Internal consistency', 'A priori knowledge'],
    notableFigures: [
      NotableFigure(name: 'René Descartes', contribution: 'Father of modern philosophy; "I think therefore I am."'),
      NotableFigure(name: 'Baruch Spinoza', contribution: 'Built ethics as a geometric proof system.'),
      NotableFigure(name: 'Immanuel Kant', contribution: 'Synthesised rationalism and empiricism.'),
    ],
    modernApplication: 'Many struggles are sustained by illogical but deeply felt beliefs. Rationalism gives you the tools to identify and challenge them — turning rumination into clear analysis.',
    quotes: [
  ...
  IsmMeta(
    id: 'phenomenology', name: 'Phenomenology', icon: '🌀',
    tagline: 'Your experience of the world is the world — for you.',
    description: 'The philosophical study of conscious experience from the first-person perspective. It validates your inner life as a legitimate subject of serious inquiry.',
    challenge: 'Sit quietly for five minutes. Describe your experience exactly as it is — not what caused it, not what it means, just what it is right now.',
    weeklyChallenge: 'Once a day, pause and ask: "What am I actually experiencing right now?" Write three honest sentences.',
    category: 'mental_emotional', visualStyle: ArtStyle.existential,
    overview: 'Phenomenology says your subjective experience is not a problem to be corrected — it\'s the primary reality. Edmund Husserl founded it as a rigorous method for examining consciousness. Heidegger extended it to "being-in-the-world." For mental health, phenomenology is radical validation: what you feel is real, and it deserves to be examined carefully.',
    historicalContext: 'Founded by Edmund Husserl in the early 20th century. Developed by Martin Heidegger (Being and Time, 1927) and Maurice Merleau-Ponty (Phenomenology of Perception, 1945). Deeply influenced modern psychotherapy.',
    coreTenets: ['First-person primacy', 'Consciousness as intentional', 'Being-in-the-world', 'Embodied experience', 'Bracketing assumptions'],
    notableFigures: [
      NotableFigure(name: 'Edmund Husserl', contribution: 'Founded phenomenology; rigorous study of consciousness.'),
      NotableFigure(name: 'Martin Heidegger', contribution: 'Being and Time; being-in-the-world.'),
      NotableFigure(name: 'Maurice Merleau-Ponty', contribution: 'Phenomenology of Perception; the body as primary.'),
    ],
    modernApplication: 'When you\'re told your feelings are "irrational," phenomenology disagrees. It says: describe your experience first. Understand it before you try to change it.',
    quotes: [
  ...
  IsmMeta(
    id: 'idealism', name: 'Idealism', icon: '🔮',
    tagline: 'The world you see is a shadow of a greater reality.',
    description: 'Plato\'s philosophical tradition: true reality lies beyond the senses, in the realm of perfect forms and ideas. The life of the mind is the highest life.',
    challenge: 'Identify one "ideal" version of yourself you\'ve glimpsed but never fully pursued. Write one step toward it.',
    weeklyChallenge: 'Each day this week, ask: "What would the best version of me do here?" Then do that thing.',
    category: 'personal_growth', visualStyle: ArtStyle.reason,
    overview: 'Plato\'s Allegory of the Cave says most people live chained in a cave, mistaking shadows for reality. The philosopher\'s task is to turn and see the light. His Theory of Forms holds that every beautiful thing points toward a perfect "Form" of Beauty. For modern life: you sense something greater is possible. That instinct is worth trusting.',
    historicalContext: 'Founded by Plato in Athens (428-348 BCE). The Academy he founded lasted nearly 1000 years. His influence spread through Augustine, Neoplatonism, and the entire Western philosophical tradition.',
    coreTenets: ['Theory of Forms', 'The examined life', 'Knowledge as recollection', 'Justice as inner harmony', 'The soul\'s journey'],
    notableFigures: [
      NotableFigure(name: 'Plato', contribution: 'Founded the Western philosophical tradition; the Academy.'),
      NotableFigure(name: 'Plotinus', contribution: 'Neoplatonism; the soul\'s return to the One.'),
      NotableFigure(name: 'Socrates', contribution: 'Plato\'s teacher; the examined life.'),
    ],
    modernApplication: 'Platonic idealism counters the flat materialism of modern life. There is something you\'re meant to pursue — a vision of what you could be. Pursue it.',
    quotes: [
  ...
  IsmMeta(
    id: 'stoic_zen', name: 'Stoic Zen', icon: '🌊',
    tagline: 'Control the mind. Flow with what remains.',
    description: 'A modern synthesis of Stoic discipline and Zen mindfulness — act decisively on what you can change, surrender peacefully to what you cannot.',
    challenge: 'When you feel resistance today, pause. Ask: "Can I control this?" If yes — act. If no — breathe, and let it pass.',
    weeklyChallenge: 'Each morning: five minutes of breath awareness (Zen), then write one thing in your control and one thing outside it (Stoic). Do this every day this week.',
    category: 'lifestyle_fusion', visualStyle: ArtStyle.mindfulness,
    overview: 'Stoic Zen is a practical daily system emerging from the surprising overlap between two traditions separated by 6,000 miles. Stoicism provides the ethical framework: the dichotomy of control, virtue through action. Zen provides the meditative engine: present-moment awareness, non-attachment. Together they form something neither has alone — discipline AND peace.',
    historicalContext: 'While historically separate, these traditions share deep parallels. Both emphasise acceptance of what cannot be changed and the emptiness of external goods. Ryan Holiday and Sam Harris have drawn these threads together in modern writing.',
    coreTenets: ['Dichotomy of control (Stoic)', 'Present awareness (Zen)', 'Non-attachment', 'Virtue through action', 'Equanimity in all things'],
    notableFigures: [
      NotableFigure(name: 'Marcus Aurelius', contribution: 'Roman emperor; Meditations as a daily practice journal.'),
      NotableFigure(name: 'Thich Nhat Hanh', contribution: 'Vietnamese Zen master; mindfulness as a way of life.'),
      NotableFigure(name: 'Epictetus', contribution: 'Stoic philosopher; taught freedom through acceptance.'),
    ],
    modernApplication: 'Stoicism gives you agency — focus only where you can act. Zen gives you peace — release everything else without clinging. Together they are one of the most effective daily systems for modern anxiety.',
    quotes: [
      '"You have power over your mind, not outside events. Realise this, and you will find strength." – Marcus Aurelius',
      '"The present moment is the only moment available to us." – Thich Nhat Hanh',
    ],
    keyWorks: ['Meditations', 'The Miracle of Mindfulness', 'The Obstacle Is the Way'],
